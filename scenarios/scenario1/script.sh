...
do
	...
	docker run -v /home/tc360950/new_sims/snv-calling/$1:/data tc360950/conset:1.0.0 clustered.py --cbs_min_cells 3  --snv_constant 0.0 --snv_candidates 100 --output_dir /data/out --data_dir /data  --counts_penalty_s2 $3 --counts_penalty_s1 $3 --sequencing_error 0.0001 --pt_inf_iters 1000000 --param_inf_iters 500000 --tree_structure_prior_k1 $4 --real_breakpoints 1 --snv_clustered 0
	python -m generator --simulation_dir ./ --stats_dir ../$2 --prefix "not_clustered_${3}_${4}"


  docker run -v /home/tc360950/new_sims/snv-calling/$1:/data tc360950/conset:1.0.0 clustered.py --cbs_min_cells 3  --snv_constant 0.0 --snv_candidates 100 --output_dir /data/out --data_dir /data  --counts_penalty_s2 $3 --counts_penalty_s1 $3 --sequencing_error 0.0001 --pt_inf_iters 1000000 --param_inf_iters 500000 --tree_structure_prior_k1 $4 --real_breakpoints 1 --snv_clustered 1
	python -m generator --simulation_dir ./ --stats_dir ../$2 --prefix "clustered_${3}_${4}"
