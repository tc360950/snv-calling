...
do
	...
	docker run -v /home/tc360950/new_sims/snv-calling/$1:/data tc360950/conset:tester1 tester.py --cbs_min_cells 3  --snv_constant 0.0 --snv_candidates 100 --output_dir /data/out --data_dir /data  --counts_penalty_s2 1000 --counts_penalty_s1 1000 --sequencing_error 0.00001 --pt_inf_iters 100000 --param_inf_iters 100000 --tree_structure_prior_k1 0.1 --real_breakpoints 1 --snv_clustered 0
	python -m generator --simulation_dir ./ --stats_dir ../$2 --prefix "tree_known_brkp_known"
