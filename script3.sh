...
do
  ...
  docker run -v /home/neuro/Desktop/snv-calling/$1:/data tc360950/conset:1.0.0 clustered.py --cbs_min_cells 3  --snv_constant 0.0 --snv_candidates 100 --output_dir /data/out --data_dir /data  --counts_penalty_s2 1000 --counts_penalty_s1 1000 --sequencing_error 0.00001 --pt_inf_iters 1000 --param_inf_iters 500000 --tree_structure_prior_k1 0.1 --real_breakpoints 1 --snv_clustered 0
	...
	docker run -v /home/neuro/Desktop/snv-calling/$1:/data tc360950/conset:tester2 tester.py --cbs_min_cells 3  --snv_constant 0.0 --snv_candidates 100 --output_dir /data/out --data_dir /data  --counts_penalty_s2 1000 --counts_penalty_s1 1000 --sequencing_error 0.00001 --pt_inf_iters 100000 --param_inf_iters 50000 --tree_structure_prior_k1 0.1 --real_breakpoints 1 --snv_clustered 0
